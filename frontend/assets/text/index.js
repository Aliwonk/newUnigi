export const textRU = {
    head: {
        meta: {
            ...
            description: 'Разработка веб-инструмента для улучшения продуктивности вашего бизнеса. Создание индивидуального решения вашей бизнес-задачи',
            keywords: 'Веб-Разработка, Сайты, Разработчики, Html, Css, JavaScript, Создание сайта'
        },
        title: {
