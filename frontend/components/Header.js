...
export default function Header() {
  ...
  const [hideMobileMenuFon, setHideMobileMenuFon] = useState(
    styles.hideMobileMenuFon
  );
        ...
        <div className={styles.mobileMenu + " " + activeMobileMenu}>
          ...
          <div className={styles.footer}>
            <div className={styles.info}>
              <Link href={text.header.contacts.telegram.href}>
              ...
              <Link href={"mailto:" + text.header.contacts.email.href}>
